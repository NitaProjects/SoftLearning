...
public class Order extends Operation implements Storable{
    ...
    public static Order getInsanceOrder(String deliveryId, String deliveryDirection, 
    ...
    public int setDeliveryDirection(String deliveryDirection) {
    ...
    public int setDeliveryPersonName(String deliveryPersonName) {
    ...
    public int setTypeOfDelivery(String typeOfDelivery) {
        ...
        for (String stringSinComas : myArray) {
            ...
            switch (key) {
                case "f": 
                    ...
                    break;
                case "h":
                    alto = (Double.parseDouble(value));
                    break;
                case "w":
                     ancho = (Double.parseDouble(value));
                    break;
                case "W":
                     peso = (Double.parseDouble(value));
                    break;
                case "d":
                     largo = (Double.parseDouble(value));
                    break;
                default:
    ...
    public int setPayingMethod(String payingMethod) {
...
public String getShopCartAsCSV() {
    ...
    public int deleteDetail (String isbn) throws BuildException {
        for (OrderDetail detail : shopCart) {
            if (detail.getIsbn().equals(isbn)) {
                shopCart.remove(Integer.valueOf(isbn));
                return 0;
            }
        }
        throw new BuildException("Invalid ISBN: " + isbn);
    ...
    public static Order getInsanceOrder(String deliveryId, String deliveryDirection, String deliveryPersonName,
